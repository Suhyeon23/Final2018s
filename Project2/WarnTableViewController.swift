...
class WarnTableViewController: UITableViewController {
    
    var fetchedArray: [WarnData] = Array()
    ...
    func downloadDataFromServer() -> Void {
        let urlString: String = "http://condi.swu.ac.kr/student/W04iphone/data/warnTable.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Warn Cell", for: indexPath)
...
*/
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toWarnCheckView" {
            if let destination = segue.destination as? WarnCheckViewController {
